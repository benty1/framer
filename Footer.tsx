      ...
      <div className="container mx-auto px-4 flex flex-col items-center text-center text-xs md:text-sm text-app-textMuted space-y-2">
        ...
        <p className="opacity-75 leading-relaxed">
          ...
          <a 
            ...
            className="text-blue-500 hover:text-blue-400 dark:text-blue-400 dark:hover:text-blue-300 transition-colors font-medium underline decoration-blue-500/30 underline-offset-4"
          >
            Tim Broddin
          </a>{' '}
          to scratch an itch.
